"""
train_tcn_perframe.py

Per-frame TCN training script.
Mirrors train_perframe.py (LSTM) for fair comparison.

Usage:
    python train_tcn_perframe.py \
        --data_dir /path/to/data \
        --save_dir /path/to/checkpoints/tcn_bh \
        --input_size 75
"""
