"""
Per-frame LSTM training script, closely following Moryossef et al. 2020:
"""
...
from model_perframe import LSTMDetectorPerFrame
from dataset_perframe import get_dataloaders, get_dataloaders_h5
...
def parse_args():
    ...
    p.add_argument("--steps_per_epoch", type=int,   default=128,
                   help="Batches per epoch. Set to -1 to use full dataset each epoch.")
...
def main():
    ...
    # steps_per_epoch: -1 means full dataset
    ...
    # Loss — pos_weight computed dynamically from training set
    ...
    print("Run evaluate_perframe.py for full metrics.")
